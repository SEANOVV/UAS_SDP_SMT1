...
Hasil analisis menunjukkan bahwa data memiliki variasi yang cukup tinggi dengan distribusi yang tidak normal, ditunjukkan oleh nilai standar deviasi yang besar serta hasil uji Shapiro–Wilk dan Q–Q plot yang menyimpang dari distribusi normal. Meskipun demikian, analisis korelasi mengungkapkan adanya hubungan positif yang sangat kuat antara pendapatan tahunan dan biaya akuisisi pelanggan, dengan koefisien korelasi mendekati satu. Temuan ini diperkuat oleh analisis regresi linear yang menghasilkan nilai R-squared sebesar 99,1%, yang berarti hampir seluruh variasi biaya akuisisi pelanggan dapat dijelaskan oleh pendapatan tahunan. Wawasan paling penting dari analisis ini adalah bahwa pendapatan tahunan merupakan prediktor yang sangat kuat dan signifikan terhadap biaya akuisisi pelanggan, sehingga model regresi yang dibangun memiliki tingkat akurasi dan daya prediksi yang sangat baik dalam konteks data yang dianalisis.
